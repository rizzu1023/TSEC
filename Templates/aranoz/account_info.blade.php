      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-lx-4">
          <div class="single_confirmation_details">
            ...
            <ul>
              <li>
                <p>First Name</p><span>Khan</span>
              </li>
              <li>
                <p>Last Name</p><span>Arman</span>
              </li>
              <li>
                <p>DOB</p><span>11/05/98</span>
              </li>
              <li>
        ...
        <div class="col-lg-6 col-lx-4">
          <div class="single_confirmation_details">
            ...
            <ul>
              <li>
                <p>Phone No</p><span>: 8879562314</span>
              </li>
              <li>
                <p>Email</p><span>: arman@gmail.com</span>
              </li>
              <li>
                <p>Lorem</p><span>: Ipsum</span>
              </li>
              <li>
                <p>Ipsum</p><span>: Lorem</span>
              </li>
            </ul>
          </div>
        </div>

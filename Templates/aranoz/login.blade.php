                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <a href="#" style="font-size: smaller;" class="btn_3">
                                <i style="padding-right: 5px;" class="fab fa-facebook-f"></i>Sign up with Facebook</a><br><br >
                            <h2>OR</h2>
                            <a href="vendorSignup.html" class="btn_3">Sign up as Vendor</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
